...
/* ESMT uses Micron 0x2c JECDEC ID on some SPI NANDs */
 ...
 * +-v-+-v--+--v--+--v--+--v--+--v--+--v--+--v---+---v---+
 * |   |    |     |     |     |     |     |      |       |
 * |0:3|4:15|16:31|32:47|48:63|64:79|80:95|96:111|112:127|
 * |   |    |     |     |     |     |     |      |       |
 * +---+----+-----+-----+-----+-----+-----+------+-------+
 *
 */
				     ...
				     struct mtd_oob_region *region)
{
	...
	/* Use only 16 ECC protected bytes per each OOB section */
	region->length = 16;
...
static int f50l2g41xa_8_ecc_get_status(struct spinand_device *spinand,
				   u8 status)
{
...
static const struct spinand_info esmt_c8_spinand_table[] = {
	...
	SPINAND_INFO("F50L2G41KA",
		     ...
		     SPINAND_INFO_OP_VARIANTS(&read_cache_variants,
					      ...
					      &update_cache_variants),
		     0,
		     SPINAND_ECCINFO(&f50l2g41ka_ooblayout, f50l2g41xa_8_ecc_get_status)),
};
...
static const struct spinand_info esmt_2c_spinand_table[] = {
	SPINAND_INFO("F50L2G41XA",
		     ...
		     SPINAND_INFO_OP_VARIANTS(&read_cache_variants,
					      ...
					      &update_cache_variants),
		     0,
		     SPINAND_ECCINFO(&f50l2g41xa_ooblayout,f50l2g41xa_8_ecc_get_status)),
};
